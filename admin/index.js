function openStatsImageInNewTab() {
  ...
  html2canvas(statsContainer).then(canvas => {
    ...
    newTab.document.write(`
      <html><head><title>Stats Image</title></head><body style="margin:0;display:flex;justify-content:center;align-items:center;height:100vh;background:#222;">
